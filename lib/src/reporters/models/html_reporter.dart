...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:dart_code_unused_linter/src/reporters/resources/variables.css',
      'package:dart_code_unused_linter/src/reporters/resources/normalize.css',
      'package:dart_code_unused_linter/src/reporters/resources/base.css',
      'package:dart_code_unused_linter/src/reporters/resources/main.css',
    ];
